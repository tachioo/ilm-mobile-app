...
class TutoringSubjectDropdown extends StatefulWidget {
  const TutoringSubjectDropdown({super.key});

  @override
  State<TutoringSubjectDropdown> createState() =>
      TutoringSubjectDropdownState();
}

class TutoringSubjectDropdownState extends State<TutoringSubjectDropdown> {
  final MultiSelectController _controller = MultiSelectController();

  @override
  Widget build(BuildContext context) {
    Iterable tutoringSubjects = [];

    void saveLanguage() async {
      String res = await StoreData()
          .saveTutoringSuject(tutoringSubjects: tutoringSubjects);
      setState(() {});
    ...
    print('first print is ${tutoringSubjects}');
            ...
            child: SingleChildScrollView(
              child: MultiSelectDropDown(
                ...
                onOptionSelected: (options) {
                  ...
                  // language = [list];
                  tutoringSubjects = list;
                  // var language = list;
                  print('second print is $tutoringSubjects');
